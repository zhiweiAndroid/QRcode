...
import com.example.shundai.erweimascan.R;
...
public class MipcaActivityCapture extends Activity implements Callback , View.OnClickListener{
	...
	public static final int COME_BACK_ERWEIMA = 400;
			...
			switch(requestCode){
				case REQUEST_CODE:
					...
					if (data != null && data.getData() != null) {
						...
						oldPath = CompressImageUtil.getRealPathFromUri(getApplicationContext(), tempuri);
					}
...
//		setResult(COME_BACK_ERWEIMA, resultIntent);
		EventBus.getDefault().post(new ResultBean(resultString,bitmap));
		finish();
	}
